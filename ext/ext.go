// Package ext defines the extension system for Weave.
// Extensions are notified of lifecycle events (collection created, ingest
...
// Extension is the base interface all Weave extensions must implement.
