...
// EmitCollectionCreated notifies all plugins that implement CollectionCreated.
...
// EmitCollectionDeleted notifies all plugins that implement CollectionDeleted.
...
// EmitIngestStarted notifies all plugins that implement IngestStarted.
...
// EmitIngestChunked notifies all plugins that implement IngestChunked.
...
// EmitIngestEmbedded notifies all plugins that implement IngestEmbedded.
...
// EmitIngestCompleted notifies all plugins that implement IngestCompleted.
...
// EmitIngestFailed notifies all plugins that implement IngestFailed.
...
// EmitRetrievalStarted notifies all plugins that implement RetrievalStarted.
...
// EmitRetrievalCompleted notifies all plugins that implement RetrievalCompleted.
...
// EmitRetrievalFailed notifies all plugins that implement RetrievalFailed.
...
// EmitDocumentDeleted notifies all plugins that implement DocumentDeleted.
...
// EmitReindexStarted notifies all plugins that implement ReindexStarted.
...
// EmitReindexCompleted notifies all plugins that implement ReindexCompleted.
